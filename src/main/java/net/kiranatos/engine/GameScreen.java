...
public interface GameScreen {
    ...
    void setCellColor(int var1, int var2, ColorJavaRush var3);

    ColorJavaRush getCellColor(int var1, int var2);
    ...
    void setCellTextColor(int var1, int var2, ColorJavaRush var3);

    ColorJavaRush getCellTextColor(int var1, int var2);

    void setCellValueEx(int var1, int var2, ColorJavaRush var3, String var4);

    void setCellValueEx(int var1, int var2, ColorJavaRush var3, String var4, ColorJavaRush var5);

    void setCellValueEx(int var1, int var2, ColorJavaRush var3, String var4, ColorJavaRush var5, int var6);

    void showMessageDialog(ColorJavaRush var1, String var2, ColorJavaRush var3, int var4);
    ...
    void onKeyPress(KeyJavaRush var1);

    void onKeyReleased(KeyJavaRush var1);
